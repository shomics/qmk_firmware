...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_5x15(
        ...
        KC_TAB,    KC_NO,    KC_BSPC,    KC_UP,    KC_DEL,    KC_R,    KC_T,    KC_VOLU,    KC_HOME,    KC_Y,    KC_7,    KC_8,    KC_9,    KC_F11,    LSFT(KC_GRV),
        MO(1),    KC_LEFT,    KC_NO,    KC_DOWN,    KC_RIGHT,    KC_F,    KC_G,    KC_LEFT,    KC_RIGHT,    KC_H,    KC_4,    KC_5,    KC_6,    KC_F12,    KC_QUOT,
       KC_LSFT,    KC_Z,    KC_X,    KC_NO,    KC_C,    KC_V,    KC_B,    KC_END,    KC_VOLD,    KC_0,    KC_1,    KC_2,    KC_3,    KC_INT3,    KC_RSFT,
